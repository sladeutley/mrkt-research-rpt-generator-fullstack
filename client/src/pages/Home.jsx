...
const RenderCards = ({ data, title }) => {
  ...
  //else we just wanna return the title
  return (
...
const Home = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-[#222328] text-[32px]">Market Research Report Generator</h1>
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Browse through a collection of Market Research Reports generated by our users. Or click on the the create button in the top right corner to create your own.</p>
      </div>
